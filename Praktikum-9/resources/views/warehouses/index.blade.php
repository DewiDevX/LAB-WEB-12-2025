        ...
        <div class="card">
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm" role="group">
                                        <a href="{{ route('warehouses.edit', $warehouse->id) }}" class="btn btn-warning" title="Edit">
                                        ...
                                        <form action="{{ route('warehouses.destroy', $warehouse->id) }}" method="POST" class="d-inline">
                                            ...
                                            <button type="submit" class="btn btn-danger" 
                                                    onclick="return confirm('Hapus gudang {{ $warehouse->name }}?')" title="Hapus">
                ...
                <div class="text-center py-4">
                    ...
                    <a href="{{ route('warehouses.create') }}" class="btn btn-primary">Tambah Gudang Pertama</a>
                </div>
                @endif
            </div>
        </div>
